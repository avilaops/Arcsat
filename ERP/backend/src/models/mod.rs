...
impl std::convert::TryFrom<String> for LeadSource {
    type Error = String;

    fn try_from(s: String) -> std::result::Result<Self, Self::Error> {
        match s.to_lowercase().as_str() {
            "website" => Ok(LeadSource::Website),
            "linkedin" => Ok(LeadSource::LinkedIn),
            "referral" => Ok(LeadSource::Referral),
            "coldcall" => Ok(LeadSource::ColdCall),
            "event" => Ok(LeadSource::Event),
            "partner" => Ok(LeadSource::Partner),
...
impl std::convert::TryFrom<String> for LeadStage {
    type Error = String;
    ...
    fn try_from(s: String) -> std::result::Result<Self, Self::Error> {
        match s.to_lowercase().as_str() {
            ...
            "qualification" => Ok(LeadStage::Qualification),
            "proposal" => Ok(LeadStage::Proposal),
            "negotiation" => Ok(LeadStage::Negotiation),
